...
#
# Output: target/zenoh-pico-cli/{z_put,z_pub,z_sub,z_get,z_queryable,z_liveliness,z_get_liveliness}
#
...
TARGETS=(z_put z_pub z_sub z_get z_queryable z_liveliness z_get_liveliness)
