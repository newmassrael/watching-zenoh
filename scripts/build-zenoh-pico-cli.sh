...
# z_queryable / z_querier / z_sub / z_liveliness / z_get_liveliness) — built
...
#
# Output: target/zenoh-pico-cli/{z_put,z_pub,z_sub,z_get,z_queryable,z_querier,z_liveliness,z_get_liveliness}
#
...
TARGETS=(z_put z_pub z_sub z_get z_queryable z_querier z_liveliness z_get_liveliness)
