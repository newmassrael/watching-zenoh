...
pub struct LocatorOwned {
    pub locator_len: u64,
    pub locator: ::sce_forge_runtime::codec::SceString<128>,
}

impl<'a> Locator<'a> {
    /// Deep-copy this borrowed zero-copy view into an owned, lifetime-free
    /// [`LocatorOwned`]. Call at a decode boundary when the
    ...
    pub fn try_into_owned(self) -> Result<LocatorOwned, CodecError> {
        Ok(LocatorOwned {
            ...
            locator: ::sce_forge_runtime::codec::SceString::from_view(self.locator)?,
        })
    }
}
