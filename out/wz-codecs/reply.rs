...
impl<'a> Default for ReplyVariant<'a> {
    fn default() -> Self {
...
impl<'a> Default for Reply<'a> {
    fn default() -> Self {
        Self {
            header: 0x04u8,
            consolidation: Default::default(),
            extensions: Default::default(),
            body: ReplyVariant::default(),
        }
    }
}
...
impl<'a> Reply<'a> {
    ...
    pub fn decode(cursor: &mut SceCursor<'a>) -> Result<Self, CodecError> {
        ...
        let body = match _peek & 0x1F {
            1u8 => ReplyVariant::CodecZenohMsgPut(MsgPut::decode(cursor)?),
            2u8 => ReplyVariant::CodecZenohMsgDel(MsgDel::decode(cursor)?),
            other => ReplyVariant::Default {
                tag: other,
    ...
    pub fn encode<S: SceSink>(&self, w: &mut S) -> Result<(), CodecError> {
        ...
        match &self.body {
            ReplyVariant::CodecZenohMsgPut(b) => {
                b.encode(w)?;
            }
            ReplyVariant::CodecZenohMsgDel(b) => {
                b.encode(w)?;
            }
            ReplyVariant::Default { body, .. } => {
                body.encode(w)?;
            }
        }
        Ok(())
...
// `Reply<'a>` above is a zero-copy view borrowing the decode
...
// `ReplyOwned`. The rkyv-style Archived(borrowed) ↔ native
...
// build-configuration time: `ReplyOwned<Heap>` holds growable
// containers with the declared capacities advisory, `ReplyOwned<Inline>`
// holds every field inline at its declared capacity and never allocates, and
// both exist in the same binary. `ReplyOwned` alone is the build's
...
#[allow(dead_code)]
#[derive(Debug, Clone, PartialEq)]
pub struct ReplyOwned<S: ::sce_forge_runtime::codec::CodecStorage = ::sce_forge_runtime::codec::DefaultStorage> {
    pub header: u8,
    pub consolidation: Option<u8>,
    pub extensions: Option<S::List<ExtEntryOwned<S>, 16>>,
    pub body: ReplyOwnedVariant<S>,
}

#[allow(dead_code)]
impl<S: ::sce_forge_runtime::codec::CodecStorage> ReplyOwned<S> {
...
#[allow(dead_code)]
#[derive(Debug, Clone, PartialEq)]
pub enum ReplyOwnedVariant<S: ::sce_forge_runtime::codec::CodecStorage = ::sce_forge_runtime::codec::DefaultStorage> {
...
impl<'a> ReplyVariant<'a> {
    ...
    pub fn try_into_owned_in<S: ::sce_forge_runtime::codec::CodecStorage>(self) -> Result<ReplyOwnedVariant<S>, CodecError> {
        Ok(match self {
            ReplyVariant::CodecZenohMsgPut(_b) => ReplyOwnedVariant::CodecZenohMsgPut(_b.try_into_owned_in::<S>()?),
            ReplyVariant::CodecZenohMsgDel(_b) => ReplyOwnedVariant::CodecZenohMsgDel(_b.try_into_owned_in::<S>()?),
            ReplyVariant::Default { tag, body } => ReplyOwnedVariant::Default { tag, body: body.try_into_owned_in::<S>()? },
        })
    }

    /// The same projection at the build's default storage profile.
    pub fn try_into_owned(self) -> Result<ReplyOwnedVariant, CodecError> {
        self.try_into_owned_in()
    }
}

#[allow(dead_code)]
impl<S: ::sce_forge_runtime::codec::CodecStorage> ReplyOwnedVariant<S> {
    ...
    /// its own.
    pub fn try_as_borrowed(&self) -> Result<ReplyVariant<'_>, CodecError> {
        Ok(match self {
            ReplyOwnedVariant::CodecZenohMsgPut(_b) => ReplyVariant::CodecZenohMsgPut(_b.try_as_borrowed()?),
            ReplyOwnedVariant::CodecZenohMsgDel(_b) => ReplyVariant::CodecZenohMsgDel(_b.try_as_borrowed()?),
            ReplyOwnedVariant::Default { tag, body } => ReplyVariant::Default { tag: *tag, body: body.try_as_borrowed()? },
        })
    }
}
...
impl<'a> Reply<'a> {
    ...
    /// [`ReplyOwned`] held in the given storage profile. Call at
    ...
    /// way.
    pub fn try_into_owned_in<S: ::sce_forge_runtime::codec::CodecStorage>(self) -> Result<ReplyOwned<S>, CodecError> {
        Ok(ReplyOwned {
            header: self.header,
    ...
    pub fn try_into_owned(self) -> Result<ReplyOwned, CodecError> {
        self.try_into_owned_in()
    }
}
...
impl<S: ::sce_forge_runtime::codec::CodecStorage> ReplyOwned<S> {
    ...
    pub fn try_as_borrowed(&self) -> Result<Reply<'_>, CodecError> {
        Ok(Reply {
            header: self.header,
            consolidation: self.consolidation,
    ...
    /// than truncated.
    pub fn transcode_in<D: ::sce_forge_runtime::codec::CodecStorage>(&self) -> Result<ReplyOwned<D>, CodecError> {
