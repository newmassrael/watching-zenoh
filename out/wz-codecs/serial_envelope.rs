...
pub struct SerialEnvelopeOwned {
    pub header: u8,
    pub payload_len: u16,
    pub payload: ::sce_forge_runtime::codec::SceBytes<1500>,
    pub crc32: u32,
}

impl<'a> SerialEnvelope<'a> {
    /// Deep-copy this borrowed zero-copy view into an owned, lifetime-free
    /// [`SerialEnvelopeOwned`]. Call at a decode boundary when the
