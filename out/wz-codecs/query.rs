...
impl<'a> Query<'a> {
    ...
    pub const MAX_ENCODED_BYTES: usize = 603;
...
#[cfg(feature = "alloc")]
#[derive(Debug, Clone, PartialEq)]
pub struct QueryOwned {
    pub header: u8,
    pub consolidation: Option<u8>,
    pub parameters_len: Option<u64>,
    pub parameters: Option<::sce_forge_runtime::codec::SceBytes<256>>,
...
impl<'a> Query<'a> {
    ...
    /// [`QueryOwned`]. Call at a decode boundary when the
