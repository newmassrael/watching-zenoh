...
pub struct InitBodyOwned {
    ...
    pub batch_size: Option<u16>,
    pub cookie_len: Option<u64>,
    pub cookie: Option<::sce_forge_runtime::codec::SceBytes<128>>,
}
...
impl<'a> InitBody<'a> {
    ...
    /// [`InitBodyOwned`]. Call at a decode boundary when the
    ...
    pub fn try_into_owned(self) -> Result<InitBodyOwned, CodecError> {
        Ok(InitBodyOwned {
            ...
            cookie: self.cookie.map(::sce_forge_runtime::codec::SceBytes::from_slice).transpose()?,
        })
    }
}
