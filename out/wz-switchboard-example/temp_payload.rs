...
pub struct TempPayloadOwned {
    pub celsius_centi: u16,
    pub sensor_id_len: u64,
    pub sensor_id: ::sce_forge_runtime::codec::SceString<64>,
    pub raw_len: u64,
    pub raw: ::sce_forge_runtime::codec::SceBytes<64>,
}

impl<'a> TempPayload<'a> {
    /// Deep-copy this borrowed zero-copy view into an owned, lifetime-free
    /// [`TempPayloadOwned`]. Call at a decode boundary when the
    ...
    pub fn try_into_owned(self) -> Result<TempPayloadOwned, CodecError> {
        Ok(TempPayloadOwned {
            ...
            sensor_id: ::sce_forge_runtime::codec::SceString::from_view(self.sensor_id)?,
            raw_len: self.raw_len,
            raw: ::sce_forge_runtime::codec::SceBytes::from_slice(self.raw)?,
        })
    }
}

impl TempPayloadOwned {
