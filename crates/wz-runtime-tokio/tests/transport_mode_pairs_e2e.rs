...
//!
//! Upstream's lean transport has no transmission pipeline AT ALL: `internal_schedule`
//! hands the message straight to `send`
//! (`io/zenoh-transport/src/unicast/lowlatency/tx.rs:30-51`), which serializes it
