...
//
// wz-ap-demo-app build.rs — gc-3 carry #2.
//
// Orchestrates the demo's switchboard value path the same way
// wz-switchboard-example/build.rs does, but for the focused live machine:
...
//      dispatch_switchboard.rs (the closed typed dispatch + the AP-dynamic
//      SensorMonitorInjector the live demo threads).
