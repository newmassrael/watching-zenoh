...
//! ride the same byte but have no pico read-out here (congestion has no
//! per-sample getter; express is a batching-only effect). Do not read this as a
//! full "qos cross-impl proven" claim.
//!
